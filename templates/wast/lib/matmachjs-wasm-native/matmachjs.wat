...
;;    i32.const 0
    ...
    set_local $dim_ptr
    ;; Create 
    (call $create_mxarray_ND (get_local $dim_ptr)(i32.const 0)(call $mxarray_core_get_simple_class (get_local $array_ptr))(i32.const 0))
...
(export "eye" (func $eye))
(func $eye (param $dim_ptr i32)(param $res_ptr i32)(result i32)
